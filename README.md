# Design Patterns — Complete Coverage Tracker

## Progress

| # | Pattern | Category | Folder | Status |
|---|---------|----------|--------|--------|
| 1 | Adapter | Structural | `adaptor_design_pattern/` | ✅ Done |
| 2 | Factory Method | Creational | `factory_design_pattern/` | ✅ Done |
| 3 | Abstract Factory | Creational | `abstract_factory_design_pattern/` | ⬜ Pending |
| 4 | Builder | Creational | `builder_design_pattern/` | ⬜ Pending |
| 5 | Prototype | Creational | `prototype_design_pattern/` | ⬜ Pending |
| 6 | Singleton | Creational | `singleton_design_pattern/` | ⬜ Pending |
...
| 18 | Observer | Behavioral | `observer_design_pattern/` | ⬜ Pending |
...
- Creational (6): How objects are created
